...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:Q88WMQH14vKWV95hMvJGzqZKL3s3gPFX3KXKfrqxb50=",
        version = "v1.40.39",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:zSrSEVlHlXDHcUOJR+03JI7ZXWjMi6Lm6GiQfVYNp14=",
        version = "v0.0.0-20210909134944-9c4e93e5b5ee",
    )
    go_repository(
        name = "com_github_buildbarn_bb_storage",
        importpath = "github.com/buildbarn/bb-storage",
        sum = "h1:42pucEg2qvE7UWkKlkL9eqVPshuR1mavxq22jRojoa8=",
        version = "v0.0.0-20210909130924-6c0280c9d0f2",
    )
    go_repository(
    ...
    go_repository(
        ...
        patches = ["@com_github_buildbarn_bb_storage//:patches/io_opentelemetry_go_otel_exporters_jaeger/http-client.diff"],
